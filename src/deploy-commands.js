...
const overseer = new SlashCommandBuilder()
  ...
  .addStringOption(o =>
    o.setName("question")
      .setDescription("Question or request")
      .setRequired(true)
  );
...
const warnings = new SlashCommandBuilder()
  ...
  .addSubcommand(s =>
    s.setName("leaderboard")
      .setDescription("Show members with the most warnings")
  )

  .addSubcommand(s =>
    s.setName("recent")
      .setDescription("Show recent server warnings")
  )
...
const intelligence = new SlashCommandBuilder()
  ...
  .addSubcommand(s =>
    s.setName("status")
      .setDescription("View proactive intelligence status")
  )

  .addSubcommand(s =>
    s.setName("enable")
      .setDescription("Enable proactive intelligence")
  )

  .addSubcommand(s =>
    s.setName("disable")
      .setDescription("Disable proactive intelligence")
  )

  .addSubcommand(s =>
    s.setName("alerts")
      .setDescription("View recent proactive alerts")
  )

  .addSubcommand(s =>
    s.setName("report")
      .setDescription("Generate an intelligence report")

      .addIntegerOption(o =>
        o.setName("days")
          .setDescription("Report window")
          .setRequired(true)
          .setMinValue(1)
          .setMaxValue(30)
      )
  ...
  .addSubcommand(s =>
    s.setName("schedule")
      .setDescription("Schedule automatic intelligence reports")
...
const cases = new SlashCommandBuilder()
  ...
  .addSubcommand(s =>
    s.setName("member")
      .setDescription("View a member's case history")
  ...
  .addSubcommand(s =>
    s.setName("stats")
      .setDescription("View case statistics")
  );
...
const ticket = new SlashCommandBuilder()
  ...
  .addSubcommand(s =>
    s.setName("panel")
      .setDescription("Post a ticket opener panel")
  );
...
const automod = new SlashCommandBuilder()
  ...
  .addSubcommand(s =>
    s.setName("mode")
      .setDescription("Set AutoMod mode")

      .addStringOption(o =>
        o.setName("mode")
          .setDescription("How AutoMod responds")
          .setRequired(true)

          .addChoices(
            {
              name: "Supervised — log and alert staff",
              value: "supervised"
            },
            {
              name: "Autonomous — timeout qualifying incidents",
              value: "autonomous"
            }
          )
      )
  ...
  .addSubcommand(s =>
    s.setName("thresholds")
      .setDescription("Configure basic detection thresholds")

      .addIntegerOption(o =>
        o.setName("spam")
          .setDescription("Messages per 10 seconds")
          .setMinValue(3)
          .setMaxValue(20)
          .setRequired(true)
      )
      ...
      .addIntegerOption(o =>
        o.setName("mentions")
          .setDescription("Mentions in one message")
          .setMinValue(2)
          .setMaxValue(20)
          .setRequired(true)
      )
...
const report = new SlashCommandBuilder()
  ...
  .addIntegerOption(o =>
    o.setName("days")
      .setDescription("Report window in days")
      .setRequired(true)
      .setMinValue(1)
      .setMaxValue(30)
  );
...
const memory = new SlashCommandBuilder()
  ...
  .addSubcommand(s =>
    s.setName("list")
      .setDescription("List stored memory")
  )
...
const confirm = new SlashCommandBuilder()
  ...
  .addStringOption(o =>
    o.setName("id")
      .setDescription("Confirmation ID shown by Overseer")
      .setRequired(true)
  );
...
const update = new SlashCommandBuilder()
  ...
  .setName("overseer-update")

  .setDescription("Manage Overseer updates and rollback")
  ...
  .addSubcommand(s =>
    s.setName("status")
      .setDescription("View current version and update status")
  )

  .addSubcommand(s =>
    s.setName("check")
      .setDescription("Check GitHub for a newer Overseer version")
  )

  .addSubcommand(s =>
    s.setName("install")
      .setDescription("Install the latest Overseer update")
  )

  .addSubcommand(s =>
    s.setName("rollback")
      .setDescription("Roll Overseer back to the previous version")
  )

  .addSubcommand(s =>
    s.setName("history")
      .setDescription("View recent update and rollback history")
  )
  ...
  .addSubcommand(s =>
    s.setName("auto")
      ...
      .addBooleanOption(o =>
        o.setName("enabled")
          .setDescription("Enable or disable automatic updates")
          .setRequired(true)
      )

      .addIntegerOption(o =>
        o.setName("interval")
          .setDescription("How often to check for updates in minutes")
          .setMinValue(5)
          .setMaxValue(1440)
      )
  );
